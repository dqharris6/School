// IncreasingTestStack.cpp -- Inherited from TestStack.cpp

#include "IncreasingArrayStack.h" 
#include "ListStack.h"
...
ofstream outfile ( "Increasing.txt" );
clock_t start;
clock_t stop;
...
//Testing IncreasingArrayStack
template <typename T, typename IT>
void test_IncreasingArrayStack(IT& _in, int _n){
  cout << "Please enter stack capacity: ";
  int stack_capacity;
  cin >> stack_capacity;
  IncreasingArrayStack<T> as1(stack_capacity);
  TestStack_correctness<IncreasingArrayStack<T>, IT>(as1, _in, _n);
...
int main(){
  ...
  //////////////////////////////////////////////////////////
  test_IncreasingArrayStack<string, string[NUM]>(in, NUM);
  ///////////////////////////////////////////////////////////
  // Test array stack using vector of 
  // random numbers as input to stack
  ///////////////////////////////////////////////////////////
  test_IncreasingArrayStack<int, vector<int> >(v, 10000000);
